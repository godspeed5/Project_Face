...
def main():
    ...
    print(os.getcwd())
    print(os.path.exists("../etc/xml/haarcascade_frontalface_alt.xml"))

    my_cascade = haarCascade("../trained_models/detection_models/haarcascade_frontalface_alt.xml", "../trained_models/detection_models/haarcascade_profileface.xml")
    #TODO If missing, example file can be retrieved from http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
    my_detector = faceLandmarkDetection('../trained_models/detection_models/shape_predictor_68_face_landmarks.dat')
